...
import org.example.chap06.bubble.BubbleSort;
import org.example.chap06.insertion.InsertionSort;
import org.example.chap07.merge.MergeSort;
import org.example.chap07.quick.QuickSort;
...
//        Arrays.sort(arr);         // 5
//        sort(arr);                // 123
//        BubbleSort.sort(arr);     // 4555
//        InsertionSort.sort(arr);  // 1941
//        MergeSort.sort(arr);      // 30
//        QuickSort.sort(arr);      //
